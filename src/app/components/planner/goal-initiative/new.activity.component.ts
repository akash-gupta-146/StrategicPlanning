...
export class NewActivity {
  ...
  submitActivity(){
    this.orgService.saveActivity(this.commonService.getData('org_info')[0].id, this.commonService.getData('org_info')[0].cycles.id,this.goalId,this.initiativeId,this.activityForm.value)
    .subscribe(response =>{
